      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="glass-card p-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div><label className="block text-xs text-surface-400 mb-1">Phone *</label><input value={primary.phone} onChange={e => setPrimary({ ...primary, phone: e.target.value })} className="input-field text-sm" placeholder="+91 XXXXXXXXXX" /></div>
          ...
          {additional.length === 0 ? (
            ...
            <div key={i} className="p-4 rounded-xl bg-surface-800/50 border border-surface-700/50 mb-3">
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                ...
                <input value={c.phone} placeholder="Phone" className="input-field text-sm py-2" onChange={e => { const arr = [...additional]; arr[i] = { ...arr[i], phone: e.target.value }; setAdditional(arr); }} />
